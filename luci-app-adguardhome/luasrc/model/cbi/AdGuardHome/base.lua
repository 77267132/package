...
o.datatype="port"
o.optional = false
o.description = translate("<input type=\"button\" class=\"adhomebutton\" value=\"Open the management page\" onclick=\"window.open('http://'+window.location.hostname+':"..httpport.."/')\"/>")
